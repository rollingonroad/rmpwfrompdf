export const en = {
  ...
  faqSecureA: 'Yes. Your files are processed only in server memory and deleted immediately after processing. We never store your PDFs on any server.',
  ...
  featureSecure: 'Never Saved',
  featureSecureDesc: 'Files are processed only in server memory and deleted immediately after processing. No copies are saved.',
